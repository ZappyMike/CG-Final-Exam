...
void IlluminationBuffer::ApplyEffect(GBuffer* gBuffer)
{
	...
	_shaders[Lights::AMBIENT]->SetUniform("u_DiffuseBool", (int)_diffuse);
	_shaders[Lights::AMBIENT]->SetUniform("u_AmbientBool", (int)_ambient);
	_shaders[Lights::AMBIENT]->SetUniform("u_Texture", (int)_texture);
...
void IlluminationBuffer::SetAmbientBool(bool ambient)
{
	_ambient = ambient;
}

void IlluminationBuffer::SetDiffuseBool(bool diffuse)
{
	_diffuse = diffuse;
}

void IlluminationBuffer::SetTextureBool(bool texture)
{
	_texture = texture;
}

bool IlluminationBuffer::getAmbient()
{
	return _ambient;
}

bool IlluminationBuffer::getDiffuse()
{
	return _diffuse;
}

bool IlluminationBuffer::getTexture()
{
	return _texture;
}
